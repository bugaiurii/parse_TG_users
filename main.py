...
from telethon.errors.rpc_errors_400 import UsernameOccupiedError
...
api_id = 22319991
api_hash = 'a34950467035419ca14ef50ebedf2814'
phone = '+79789150098'
limit = 100
...
def dump_users(chat, client):
    ...
    while True:
        participants = client.invoke(GetParticipantsRequest(chat_object, ChannelParticipantsSearch(''), offset, limit))
